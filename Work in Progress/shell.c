...
int main()
{
        ...
        while (1)
        {
                ...
                seventh = string_compare(line, "kill\0");
                if (first)
                {
                        copy(line, word, 5);
                        buffer[0] = 0x00;
                ...
                {
                        copy(line, word, 5);
                        interrupt(0x10, 0xE * 256 + (word+48), 0, 0, 0);
                        interrupt(0x10, 0xE * 256 + ('w'), 0, 0, 0);
                        interrupt(0x10, 0xE * 256 + (word+48), 0, 0, 0);
                        intFromString=getNum(word);
                        interrupt(0x10, 0xE * 256 + (intFromString+48 ), 0, 0, 0);
                        //interrupt(0x21, 9, intFromString, 0,0);
                }
                else
                {
...
int getNum(char *in){
   ...
   // interrupt(0x10, 0xE * 256 + ('9' ), 0, 0, 0);
...
if(*in==4){
    interrupt(0x10, 0xE * 256 + ('4' ), 0, 0, 0);
    return 4;
}
if(*in==5){
    interrupt(0x10, 0xE * 256 + ('5' ), 0, 0, 0);
    return 5;
}
if(*in==6){
    interrupt(0x10, 0xE * 256 + ('6' ), 0, 0, 0);
    return 6;  
}
if(*in==7){
    interrupt(0x10, 0xE * 256 + ('7' ), 0, 0, 0);
    return 7; 
}
    c[0] = 'N';
    c[1] = '\0';
