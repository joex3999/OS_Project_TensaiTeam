...
int main()
{
        ...
        while (1)
        {
                ...
                else if (seventh)
                {
                        ...
                        interrupt(0x21, 9, intFromString, 0x2000,0);
                }
                else
                {
...
if(string_compare(*in,"0\0"))
    return 0;
if(string_compare(*in,"1\0"))
    return 1;
if(string_compare(*in,"2\0"))
    return 2;
if(string_compare(*in,"3\0"))
    return 3;
if(string_compare(*in,"4\0"))
    return 4;
if(string_compare(*in,"5\0"))
    return 5;
if(string_compare(*in,"6\0"))
    return 6;  
if(string_compare(*in,"7\0"))
    return 7; 
